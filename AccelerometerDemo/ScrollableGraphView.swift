...
//  AccelerometerDemo
//
//  Created by ナム Nam Nguyen on 5/27/17.
...
open class ScrollableGraphView: UIScrollView, UIScrollViewDelegate, ScrollableGraphViewDrawingDelegate {
    ...
    open var shouldDrawBarLayer: Bool = false
    ...
    open var dataPointSpacing: CGFloat = 40
    ...
    open var shouldAutomaticallyDetectRange: Bool = false
    ...
    open var shouldRangeAlwaysStartAtZero: Bool = false // Used in conjunction with shouldAutomaticallyDetectRange, if you want to force the min to stay at 0.
    ...
    open var shouldDrawDataPoint: Bool = true
    ...
    open var shouldAdaptRange: Bool = false
    ...
    open var shouldAnimateOnAdapt: Bool = true
    ...
    open var animationDuration: Double = 1
    
    var adaptAnimationType_: Int {
    ...
    open var shouldAnimateOnStartup: Bool = true
    
    // Reference Lines
    // ###############
    
    /// Whether or not to show the y-axis reference lines and labels.
    open var shouldShowReferenceLines: Bool = true
    /// The colour for the reference lines.
    open var referenceLineColor: UIColor = UIColor.black
    /// The thickness of the reference lines.
    open var referenceLineThickness: CGFloat = 0.5
    
    var referenceLinePosition_: Int {
    ...
    open var numberOfIntermediateReferenceLines: Int = 3
    /// Whether or not to add labels to the intermediate reference lines.
    open var shouldAddLabelsToIntermediateReferenceLines: Bool = true
    ...
    open var shouldAddUnitsToIntermediateReferenceLineLabels: Bool = false
    ...
    open var dataPointLabelsSparsity: Int = 1
